...
private:
    ...
    std::string cppBaseType(const std::string& name) {
        ...
        // This handles cross-file includes where the type was declared in a
        // different .ks file and isn't in m_userNodeTypes for this compilation unit.
        // Primitive types, engine types, and value types are all handled above,
        // so anything reaching here must be a class/node type.
        return name + "*";
