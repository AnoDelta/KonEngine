# tools/KonAnimator/windows-cross-toolchain.cmake
# Cross-compilation: Linux -> Windows (x86_64) using MXE
...
if(NOT EXISTS "${MXE_ROOT}")
    message(FATAL_ERROR
        "MXE not found. Install it or set -DMXE_ROOT=/path/to/mxe\n"
        "  git clone https://github.com/mxe/mxe.git ~/mxe\n"
        "  cd ~/mxe && make -j\$(nproc) MXE_TARGETS=x86_64-w64-mingw32.static qt5")
endif()
